	...
	var storePerformance = function() {
		...
		if((storedPerf != true && window.performance && window.performance.timing)) {
			...
			if(nav_start > 0 && complete > 0) {
				...
				log("perf_nav_to_connect: "+perf_nav_to_connect);
				log("perf_connect_to_resp_start: "+perf_connect_to_resp_start);
				log("perf_resp_time: "+perf_resp_time);
				log("perf_interactive: "+perf_interactive);
				log("perf_contentloaded: "+perf_contentloaded);
				log("perf_complete: "+perf_complete);
